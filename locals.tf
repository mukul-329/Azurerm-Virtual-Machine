locals {
  ...
  network_interface_card_name=var.network_interface_card_name=="nic-default" ? "${var.virtual_machine_name}-${var.netowrk_interface_card_name}":var.network_interface_card_name
